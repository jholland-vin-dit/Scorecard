...
$sql_state_county_municipality = pg_query($link, $str_state_county_municipality);
...
while($row_state_county_municipality = pg_fetch_assoc($sql_state_county_municipality)){
